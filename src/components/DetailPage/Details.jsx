...
const Details = (props) => {
  ...
  return (
    <>
          ...
          <div className="offset-1">
            ...
            <h6>
              ...
              {movieData?.genres.map((item) => (
                <GenreButton key={item?.id} className="inline-block">
                  {item.name}{" "}
                </GenreButton>
              ))}
            </h6>
      ...
      <h2 className="my-2">Reparto de la película:</h2>
      <div
        className="container d-flex flex-row justify-content-center row mb-2"
