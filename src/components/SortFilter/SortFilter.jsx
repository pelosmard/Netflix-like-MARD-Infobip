      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-sm-12">
            ...
            >
              <option defaultValue="DEFAULT">Ordenado por</option>
              <option defaultValue="original_title.asc">A--Z</option>
              <option defaultValue="2">Z--A</option>
              <option defaultValue="3">Más Populares</option>
              <option defaultValue="4">Menos Populares</option>
              <option defaultValue="5">Lanzamiento más reciente</option>
              <option defaultValue="6">Lanzamiento más antiguo</option>
            </select>
                ...
                <div key={item.id} className="col-sm ">
                  ...
                  >
                    <Card style={{ width: "18rem" }}>
                      ...
                      />
                      <Card.Body>
                        <Card.Title className="text-muted fw-bold ">
                          {item.title}
                        </Card.Title>
